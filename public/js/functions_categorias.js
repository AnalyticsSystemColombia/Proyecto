 ...
 if(document.querySelector(".delPhoto")){
  ...
  //NUEVA CATEGORIA
    ...
    formCategoria.onsubmit = function(e) {
        e.preventDefault();
        let strNombre = document.querySelector('#txtcateNomb').value;
        let strDescripcion = document.querySelector('#txtcateDesc').value;
...
function fntViewInfo(cateCodi){
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = base_url+'/Categorias/getCategoria/'+cateCodi;
    ...
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                '<span class="badge badge-success">Activo</span>' : 
                '<span class="badge badge-danger">Inactivo</span>';
                document.querySelector("#celId").innerHTML = objData.data.cateCodi;
                document.querySelector("#celNombre").innerHTML = objData.data.cateNomb;
                document.querySelector("#celDescripcion").innerHTML = objData.data.cateDesc;
...
function fntEditInfo(element,cateCodi){
