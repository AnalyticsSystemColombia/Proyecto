						...
						<div class="wrap-table-shopping-cart">
							...
							<?php 
								foreach ($_SESSION['arrCarrito'] as $producto) {
									...
									$prodId = openssl_encrypt($producto['prodId'],METHODENCRIPT,KEY);
								
							 ?>
								<tr class="table_row <?= $prodId ?>">
									<td class="column-1">
										<div class="how-itemcart1" idpr="<?= $prodId ?>" op="2" onclick="fntdelItem(this)" >
									...
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											...
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" value="<?= $producto['cantidad'] ?>" idpr="<?= $prodId ?>">
