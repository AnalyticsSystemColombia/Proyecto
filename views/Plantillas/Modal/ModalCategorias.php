              ...
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" id="txtcateNomb" name="txtcateNomb" type="text" placeholder="Nombre Categoría" required="">
                    </div>
                    <div class="form-group">
                      <label class="control-label">Descripción <span class="required">*</span></label>
                      <textarea class="form-control" id="txtcateDesc" name="txtcateDesc" rows="2" placeholder="Descripción Categoría" required=""></textarea>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="photo">
                        <label for="foto">Foto (260x234)</label>
                        <div class="prevPhoto">
