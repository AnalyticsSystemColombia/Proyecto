...
<main class="app-content">
  <div class="row user">
    <div class="col-md-12">
      <div class="profile">
        <div class="info"><img class="user-img" src="<?= media();?>/imagenes/SISO.png">
          <?= $_SESSION['userData']['nombres'].' '.$_SESSION['userData']['apellidos']; ?></h4>
          <p><?= $_SESSION['userData']['roleNomb']; ?></p>
        </div>
    ...
    <div class="col-md-3">
      <div class="tile p-0">
        <ul class="nav flex-column nav-tabs user-tabs">
          ...
          <li class="nav-item"><a class="nav-link" href="#user-cuenta" data-toggle="tab">Cuenta</a></li>
        </ul>
      </div>
    </div>
    <div class="col-md-9">
      <div class="tab-content">
        ...
        <div class="tab-pane fade" id="user-cuenta">
          <div class="tile user-settings">
            <h4 class="line-head">Cuenta díaria</h4>
