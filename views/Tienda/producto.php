				...
				<div class="col-md-6 col-lg-7 p-b-30">
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<?php
							if(!empty($arrImg)){
								for ($img=0; $img <count($arrImg); $img++) {
								?> 
								<div class="item-slick3" data-thumb="<?= $arrImg[$img]['url_image']; ?>">
									<div class="wrap-pic-w pos-relative">
									<img src="<?= $arrImg[$img]['url_image']; ?>" alt="IMG-PRODUCT">

									<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= $arrImg[$img]['url_image']; ?>">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<span class="mtext-106 cl2">
							<?= SMONEY.formatMoney($arrProducto['prodPrec']); ?>
						</span>
